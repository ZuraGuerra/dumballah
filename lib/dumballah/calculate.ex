defmodule Dumballah.Calculate do
  ...
  ## Examples
      ...
      1474407134
  """
  @spec add_time(integer, atom, integer) :: integer
  ...
  ## Examples
      ...
      1474234334
  """
  @spec substract_time(integer, atom, integer) :: integer
  ...
  ## Examples
      ...
      true
  """
  @spec has_passed?(integer) :: boolean
  ...
  ## Examples
      ...
      804729600
  """
  @spec date_from_dawn({integer, integer, integer}) :: integer
  ...
  ## Examples
      ...
      72900
  """
  @spec seconds_until_midnight({integer, integer, integer}) :: integer
